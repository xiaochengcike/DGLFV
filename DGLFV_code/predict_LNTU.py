...
if __name__ == "__main__":
    ...
    GPU_Conf()
    # LNTU Model weight Path & Data Path
    model_path = 'roc/LNTU_IRV2/IRV2_LNTU_500.h5'    

    train_path = 'LNTU_enhancement/LNTU_data_enhancement/train'
    test_path = 'LNTU_enhancement/LNTU_data_enhancement/test'
    notrain_path = 'LNTU_enhancement/LNTU_data_enhancement/notrain'
           
    # Set LNTU test data batch size
    batch_size = 101 #101
    train_generator_round = 8
    test_generator_round = 4
    notrain_generator_round = 1
