...
if __name__ == "__main__":	
    ...
    IMAGE_DIR = os.path.join(ROOT_DIR, "open_data/")
    ...
    for i in range(len(filenames)):
        image = skimage.io.imread(os.path.join(IMAGE_DIR,filenames[i]))
        # Run detection
        ...
        # Save binery mask for the next step
        image_path= "./Mask_result/"+filenames[i]        
        skimage.io.imsave(image_path,bimage)
        ...
        skimage.io.imsave("./ROI_result/"+filenames[i],roi_image)
